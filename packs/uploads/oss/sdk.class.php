...
class ALIOSS{
	...
	public function set_bucket_logging($bucket, $target_bucket, $target_prefix, $options = NULL){
		...
		$xml = new SimpleXMLElement('<?xml version="1.0" encoding="gbk"?><BucketLoggingStatus></BucketLoggingStatus>');
	...
	public function set_bucket_website($bucket, $index_document, $error_document, $options = NULL){
		...
		$xml = new SimpleXMLElement('<?xml version="1.0" encoding="gbk"?><WebsiteConfiguration></WebsiteConfiguration>');
	...
	public function set_bucket_cors($bucket, $cors_rules, $options = NULL){
		...
		$xml = new SimpleXMLElement('<?xml version="1.0" encoding="gbk"?><CORSConfiguration></CORSConfiguration>');
	...
	public function delete_objects($bucket, $objects, $options = null){
		...
		$xml = new SimpleXMLElement('<?xml version="1.0" encoding="gbk"?><Delete></Delete>');
	...
	public function complete_multipart_upload($bucket, $object, $upload_id, $parts, $options = NULL){
		...
		if(is_string($parts)){
			...
			$xml = new SimpleXMLElement('<?xml version="1.0" encoding="gbk"?><CompleteMultipartUpload></CompleteMultipartUpload>');
