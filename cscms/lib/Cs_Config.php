...
define('Admin_QQ','809444585');  //站长QQ  
define('Admin_Tel','15260321520');  //站长电话  
define('Admin_Mail','809444585@qq.com');  //站长EMAIL  
define('Web_Key','Dj小波|DJ黄子浩|Dj罗清|DJ文杰|DJ千里|Mc洋哥');  //热门搜索  
define('Web_Count','统计代码');  //统计代码  
define('Web_Title','DJ小丽'); //SEO-标题  
define('Web_Keywords','dj，音乐，小丽'); //SEO-Keywords  
define('Web_Description','DJ小丽音乐网'); //SEO-description  
define('Web_Notice','网站公告');  //网站公告  
define('Pl_Modes',0);  //评论方式  
define('Pl_Youke',0);  //游客是否可以评论  
define('Pl_Num',10);  //评论每页条数  
define('Pl_Yy_Name','1');  //友言账号  
...
define('Mobile_Win',0);   //电脑是否可以访问手机页面    
define('Mobile_Skins','default/html/');  //手机门户模板路径    
define('Web_Skins','default/html/');  //默认主页模板路径    