...
class Pay extends Cscms_Controller {
	...
	public function save()
	{
	        ...
	        $strs.="define('CS_Alipay_JK',".$CS_Alipay_JK.");  //支付宝接口,1为双功能接口，2为及时倒账，3为手动接口\r\n";
	        ...
	        $strs.="define('CS_Kqpay',".$CS_Kqpay.");  //快钱  \r\n";
	        $strs.="define('CS_Kqpay_ID','".$CS_Kqpay_ID."');  //快钱ID  \r\n";
	        $strs.="define('CS_Kqpay_Key','".$CS_Kqpay_Key."');  //安全验效码KEY\r\n";
	...
	public function init()
	{
			...
			if($row){
			     ...
			     $this->CsdjEmail->send($email,$title,$emailneir);  //发送通知邮件
			}
	...
	public function del()
	{
            ...
            admin_msg(L('plub_05'),site_url('pay/lists'),'ok');  //操作成功
	}
	...
	public function spend_del()
	{
            ...
            admin_msg(L('plub_05'),site_url('pay/spend'),'ok');  //操作成功
	}
	...
	public function income_del()
	{
            ...
            admin_msg(L('plub_05'),site_url('pay/income'),'ok');  //操作成功
	}
	...
	public function card_save()
	{
            ...
            admin_msg(L('plub_05'),site_url('pay/card'),'ok');  //操作成功
	}
